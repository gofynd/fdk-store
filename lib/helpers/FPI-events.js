...
export const FPI_EVENTS = {
    ...
    ADD_TO_WISHLIST: {
        ...
        payloadCreator: (result, param, store) => {
            ...
            const allItems = [
                ...
                ...((_j = (_h = store.cart) === null || _h === void 0 ? void 0 : _h.cart_items.items) !== null && _j !== void 0 ? _j : []),
                ...(((_k = store.catalog) === null || _k === void 0 ? void 0 : _k.product_details)
                    ? [store.catalog.product_details]
                    : []),
            ];
            const collectionId = ((_l = param[0]) === null || _l === void 0 ? void 0 : _l.collectionId) || "";
            ...
            if (item === null || item === void 0 ? void 0 : item.product) {
                return {
                    item: Object.assign(Object.assign(Object.assign({}, item), item.product), { price: {
                            effective: {
                                max: (_o = (_m = item === null || item === void 0 ? void 0 : item.price) === null || _m === void 0 ? void 0 : _m.converted) === null || _o === void 0 ? void 0 : _o.effective
                            }
                        } }),
                };
            }
    ...
    UPDATE_CART: {
        ...
        payloadCreator: (result, param, store, oldStore) => {
            ...
            const operationType = param[0].body.operation;
            const isRemoveOperation = operationType === 'remove_item';
            const itemsSource = isRemoveOperation ? (_b = (_a = oldStore === null || oldStore === void 0 ? void 0 : oldStore.cart) === null || _a === void 0 ? void 0 : _a.cart_items) === null || _b === void 0 ? void 0 : _b.items : (_d = (_c = result.payload) === null || _c === void 0 ? void 0 : _c.cart) === null || _d === void 0 ? void 0 : _d.items;
            let operation;
            let data = param === null || param === void 0 ? void 0 : param.map(({ body: { items } }) => {
                var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
                if (!itemsSource)
                    return;
                const item = itemsSource.find((i) => { var _a, _b; return ((_a = i === null || i === void 0 ? void 0 : i.product) === null || _a === void 0 ? void 0 : _a.uid) === ((_b = items[0]) === null || _b === void 0 ? void 0 : _b.item_id); });
                if (!item)
                    return;
                const { article, availability, product, price, price_per_unit, quantity: newQuantity, } = item;
                const oldQuantity = item.quantity;
                operation = newQuantity > oldQuantity ? "increment_quantity" : "decrement_quantity";
                return {
                    article: { uid: article === null || article === void 0 ? void 0 : article.uid },
                    category: { uid: (_b = (_a = product === null || product === void 0 ? void 0 : product.categories) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.uid, name: (_d = (_c = product === null || product === void 0 ? void 0 : product.categories) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.name },
                    brand: { uid: (_e = product === null || product === void 0 ? void 0 : product.brand) === null || _e === void 0 ? void 0 : _e.uid, name: ((_f = product === null || product === void 0 ? void 0 : product.brand) === null || _f === void 0 ? void 0 : _f.name) || ((_g = product === null || product === void 0 ? void 0 : product.attributes) === null || _g === void 0 ? void 0 : _g.brand_name) },
                    name: product === null || product === void 0 ? void 0 : product.name,
                    item_code: product === null || product === void 0 ? void 0 : product.item_code,
                    price: price === null || price === void 0 ? void 0 : price.converted,
                    price_per_unit,
                    quantity: { current: (_h = items[0]) === null || _h === void 0 ? void 0 : _h.quantity },
                    uid: product === null || product === void 0 ? void 0 : product.uid,
                    store: { uid: (_j = article === null || article === void 0 ? void 0 : article.store) === null || _j === void 0 ? void 0 : _j.uid },
                    seller: { uid: (_k = article === null || article === void 0 ? void 0 : article.seller) === null || _k === void 0 ? void 0 : _k.uid },
