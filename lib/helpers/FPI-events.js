...
export const FPI_EVENTS = {
    ...
    ADD_TO_WISHLIST: {
        ...
        payloadCreator: (result, param, store) => {
            var _a, _b, _c, _d;
            const allItems = (_c = (_b = (_a = store.products) === null || _a === void 0 ? void 0 : _a.product_lists) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.items;
            const collectionId = ((_d = param[0]) === null || _d === void 0 ? void 0 : _d.collectionId) || "";
