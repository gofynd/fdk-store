...
export function createCacheProxy(moduleName, instance, dispatch, eventEmitter) {
    const proxied = new Proxy(instance, {
        get(target, prop) {
            ...
            if (targetFunc && typeof targetFunc === 'function') {
                ...
                const expectedNumberOfArguments = (mappedEventMeta === null || mappedEventMeta === void 0 ? void 0 : mappedEventMeta.argument) || 1;
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            ...
                            if (((_e = result === null || result === void 0 ? void 0 : result.meta) === null || _e === void 0 ? void 0 : _e.requestStatus) === 'fulfilled') {
                                if (overrideOptions === null || overrideOptions === void 0 ? void 0 : overrideOptions.skipFPIEvent) {
                                    return result;
                                }
                                const isEmitted = emitFPIEvent(meta.successEvent, params, result, oldStore, eventEmitter);
                                if (!isEmitted) {
                                    dispatch(setValue({
                                        key: `fpiEvent${meta.successEvent.eventName}`,
                                        value: {
                                            key: meta.successEvent.eventName,
                                            params,
                                            result
                                        }
                                    }));
                            ...
                            if (((_f = result === null || result === void 0 ? void 0 : result.meta) === null || _f === void 0 ? void 0 : _f.requestStatus) === "rejected") {
                                ...
                                const isEmitted = emitFPIEvent(meta.failEvent, params, result, oldStore, eventEmitter);
                                if (!isEmitted) {
                                    dispatch(setValue({
                                        key: `fpiEvent${meta.failEvent.eventName}`,
                                        value: {
                                            key: meta.failEvent.eventName,
                                            params,
                                            result
                                        }
                                    }));
