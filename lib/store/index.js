...
import { isStoreEqual } from "../helpers/utils";
class ApplicationStore {
    constructor(sdk, initialData, graphqlFetcher, eventEmitter) {
        ...
        this.getters = {
            ...
            USER_EXIST: (store) => store.auth.user_exist,
            //filestorage getters
    ...
    observeStore(getterFunction, onChange, equalityFunction = isStoreEqual) {
        let previousState;
        const handleChange = () => {
            var _a, _b, _c;
            let currentState = getterFunction((_c = (_b = (_a = this === null || this === void 0 ? void 0 : this.store) === null || _a === void 0 ? void 0 : _a.getState) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : {});
            if (!equalityFunction(previousState, currentState)) {
    ...
    executeGQL(query, params) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.graphqlFetcher.fetch(query, params);
        });
    }
}
