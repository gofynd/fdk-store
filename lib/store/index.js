...
class ApplicationStore {
    constructor(sdk, initialData, eventEmitter) {
        ...
        this.catalog = createCacheProxy('catalog', new CatalogModule(dispatch), eventEmitter);
        ...
        this.fileStorage = createCacheProxy('fileStorage', new fileStorageModule(dispatch), eventEmitter);
