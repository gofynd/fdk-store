...
export function transactOrder(sdk, state, paymentOptions, payment_config, create_order = createOrder) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        //Figure out current payment gateway
        let currentPaymentGatway;
        if (((_b = (_a = paymentOptions.payment) === null || _a === void 0 ? void 0 : _a.paymentFlowMeta) === null || _b === void 0 ? void 0 : _b.type) ==
            'standard_extension') {
            currentPaymentGatway = PaymentGatway['StandardExtension'];
        }
        else {
            currentPaymentGatway = PaymentGatway[paymentOptions.aggregator];
        }
        if (currentPaymentGatway.injectScript) {
        ...
        if (orderInfo.success) {
            ...
            let rbiGuidelineSave = Object.assign(Object.assign({}, (isLoggedIn
                ? {
                    checkedBoxValue: (_c = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _c === void 0 ? void 0 : _c.is_card_secure,
                }
                : { checkedBoxValue: false })), { paymentdata: Object.assign(Object.assign({}, paymentOptions), { option: {
                        card_number: ((_d = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _d === void 0 ? void 0 : _d.card_token)
                            ? ''
...
export function updateOrderInfo(currentPaymentGatway, orderInfo, paymentOptions) {
    ...
    if (paymentOptions.payment_mode === 'UPI' && currentPaymentGatway.createUPIPaymentData) {
