...
;
export function handleCODOrder(sdk, state, paymentOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        const orderInfo = yield createOrder(sdk, paymentOptions);
...
export function transactOrder(sdk, state, paymentOptions) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let orderInfo = yield createOrder(sdk, paymentOptions);
        if (orderInfo.success) {
            // Reset ordering store in case of successful checkout
            removeCookie(COOKIE_KEYS.ORDERING_STORE);
