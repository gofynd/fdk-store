    ...
    transaction(obj, payload) {
        ...
        try {
            ...
            if (self.selectedPayment.aggregator_name.toLowerCase() === 'jio' &&
                self.selectedPayment.name.toLowerCase() !== 'jiopp' &&
                self.selectedPayment.name.toLowerCase() !== 'jiopplink') {
                ...
                console.log(JSON.stringify({ paymentBody })); //TODO tobe removed
                return fetch(self.paymentFlow.api_link, {
                    method: 'POST',
                    mode: 'cors',
                    headers: {
                    ...
                    .then((res) => res.json())
                    .then((d) => {
                    console.log(d); //TODO tobe removed
