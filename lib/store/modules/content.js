...
import { getApplication } from "../slices/configuration";
import { getAnnouncements, getSEOConfiguration, getBlog, getBlogs, getPage, getDataLoaders, getFaqsByCategorySlug, getLandingPage, getLegalInformation, getNavigations, getSlideshows, getSupportInformation, getTags, getFaqCategories, getFaqCategoryBySlug, getFaqs, setDataLoaders, getCustomFields, } from "../slices/content";
export class ContentModule {
    ...
    getCustomFields(params) {
        return this.dispatch(getCustomFields(params));
    }
    ...
    setDataLoaders() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const application = yield this.dispatch(getApplication());
