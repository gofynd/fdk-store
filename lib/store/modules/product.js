...
export class ProductModule {
    ...
    fetchProductBySlug(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let data = yield Promise.all([this.dispatch(fetchProductDetails(params)), this.dispatch(fetchProductMeta(params))]);
            if (((_a = data === null || data === void 0 ? void 0 : data[0].payload) === null || _a === void 0 ? void 0 : _a.has_variant) && params.slug) {
                yield this.dispatch(fetchProductVariants(params));
            }
            else {
                yield this.dispatch(fetchProductVariants(null));
            }
            return data[0];
        });
    }
