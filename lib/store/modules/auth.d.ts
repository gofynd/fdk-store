...
export declare class AuthModule {
    ...
    sendForgotOTPOnMobile(params: SendForgotOTPOnMobileParam): AsyncThunkPromise<OtpSuccess>;
    sendForgotOTPOnEmail(params: SendForgotOTPOnEmailParam): AsyncThunkPromise<EmailOtpSuccess>;
