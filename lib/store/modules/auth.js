...
import { addEmail, addMobileNumber, deleteEmail, deleteMobileNumber, deleteUser, facebookLogin, getPlatformConfig, fetchUserData, forgotPassword, getListOfActiveSessions, googleLogin, hasPassword, loginWithAppleIOS, resetPasswordWithEmail, resetPasswordWithMobile, sendOtp, sendOtpEmail, sendOtpMobile, setUserData, signInUserWithPassword, updateProfile, verifyEmailOtp, verifyMobileOtp, getLoggedInUser, logout, registerWithForm, loginWithEmailAndPassword, verifyMobileOTP, sendVerificationLinkToEmail, } from "../slices/auth";
