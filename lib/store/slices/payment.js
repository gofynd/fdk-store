...
export const checkoutPayment = createAsyncThunk('checkoutPayment', (payload, { extra, getState }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { cart_id, payment, meta, custom_meta, paymentflow, address_id, aggregator_name, billing_address_id, payment_identifier, payment_mode, queryParams, merchant_code, callback_url = '', payment_config = '' } = payload;
