...
export const getPaymentModeRoutes = createAsyncThunk('paymentOptions', (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    return sdk.payment.getPaymentModeRoutes(params);
}));
export const validateVPA = createAsyncThunk('validateVPA', (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    return sdk.payment.validateVPA(params);
}));
export const getAggregatorsConfig = createAsyncThunk('aggregatorConfig', (_, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
...
export const checkoutPayment = createAsyncThunk('checkoutPayment', (payload, { extra, getState }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { cart_id, payment, meta, custom_meta, paymentflow, address_id, aggregator_name, billing_address_id, payment_identifier, payment_mode, queryParams, merchant_code, callback_url = '', order_type, payment_config = '' } = payload;
    ...
    const paymentOptions = Object.assign(Object.assign(Object.assign(Object.assign({ address_id: address_id || queryParams.address_id, billing_address_id: billing_address_id ||
            ...
            queryParams.address_id, aggregator: aggregator_name || queryParams.aggregator_name, payment_identifier: payment_identifier || queryParams.payment_identifier, payment_mode: payment_mode || queryParams.payment_mode, callback_url: callback_url || window.location.origin + '/cart/order-status', payment: mutablePayment, meta, merchant_code: merchant_code }, (order_type ? { order_type } : {})), (cart_id ? { id: cart_id } : {})), (custom_meta && custom_meta.length > 0 ? { custom_meta } : {})), { ordering_store: undefined });
    ...
    return transactOrder(sdk, state, paymentOptions, payment_config);
}));
