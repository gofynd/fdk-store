...
export const checkoutPayment = createAsyncThunk('checkoutPayment', (payload, { extra, getState }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { cart_id, payment, meta, custom_meta, paymentflow, address_id, billing_address_id, aggregator_name, payment_identifier, payment_mode, queryParams, payment_config = '', callback_url, } = payload;
