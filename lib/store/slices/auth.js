...
export const getPlatformConfig = createAsyncThunk("platformData", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    return sdk.user.getPlatformConfig(params);
}));
export const setMobileNumberAsPrimary = createAsyncThunk("setMobileNumberAsPrimary", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    return sdk.user.setMobileNumberAsPrimary(params);
}));
...
export const sendForgotOTPOnMobile = createAsyncThunk("sendForgotOTPOnMobile", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    const data = yield sdk.user.sendForgotOTPOnMobile(params);
    return data;
}));
export const sendForgotOTPOnEmail = createAsyncThunk("sendForgotOTPOnEmail", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    const data = yield sdk.user.sendForgotOTPOnEmail(params);
    return data;
}));
export const userExists = createAsyncThunk("userExists", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    const data = yield sdk.user.userExists(params);
    return data;
}));
...
export const loginWithEmailAndPassword = createAsyncThunk("loginWithEmailAndPassword", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    return sdk.user.loginWithEmailAndPassword(params);
}));
export const getLoggedInUser = createAsyncThunk("getLoggedInUser", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    return sdk.user.getLoggedInUser(params);
}));
...
export const logout = createAsyncThunk("logout", (_, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    const data = yield sdk.user.logout();
    return data;
}));
export const registerWithForm = createAsyncThunk("registerWithForm", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
...
export const updatePassword = createAsyncThunk("updatePassword", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
    const data = yield sdk.user.updatePassword(params);
    return data;
}));
...
export const sendVerificationLinkToEmail = createAsyncThunk("sendVerificationLinkToEmail", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    const { sdk } = extra;
...
const authSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(getPlatformConfig.pending, (state) => {
            state.platform_data.loading = true;
        })
            .addCase(getPlatformConfig.fulfilled, (state, action) => {
            state.platform_data = action.payload;
            state.platform_data.error = null;
            state.platform_data.loading = false;
        })
            .addCase(getPlatformConfig.rejected, (state, action) => {
            state.platform_data = {};
            ...
            state.user_exist = action.payload;
        })
